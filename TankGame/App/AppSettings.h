...
#define APP_VIRTUAL_WIDTH		(1280)					// This will be the effective x resolution regardless of actual screen/window res.
#define APP_VIRTUAL_HEIGHT		(720)					// This will be the effective y resolution regardless of actual screen/window res.
...
#define APP_WINDOW_TITLE		("TankGame")

#define APP_ENABLE_DEBUG_INFO_BUTTON		(VK_F3)
#define APP_QUIT_KEY						(VK_ESCAPE)
#define APP_FULLSCREEN_KEY					(VK_F11)
...
#define APP_PAD_EMUL_START				(VK_TAB)

#define APP_PAD_EMUL_RIGHT_THUMB_LEFT	(VK_LEFT)
#define APP_PAD_EMUL_RIGHT_THUMB_RIGHT	(VK_RIGHT)
#define APP_PAD_EMUL_RIGHT_THUMB_UP		(VK_UP)
#define APP_PAD_EMUL_RIGHT_THUMB_DOWN	(VK_DOWN)

#define APP_PAD_EMUL_DPAD_UP			(VK_NUMPAD4)
#define APP_PAD_EMUL_DPAD_DOWN			(VK_NUMPAD6)
#define APP_PAD_EMUL_DPAD_LEFT			('1')
#define APP_PAD_EMUL_DPAD_RIGHT			('2')
	
#define APP_PAD_EMUL_BUTTON_BACK		(VK_BACK)
#define APP_PAD_EMUL_BUTTON_A			(VK_SPACE)
#define APP_PAD_EMUL_BUTTON_B			(VK_END)
#define APP_PAD_EMUL_BUTTON_X			(VK_RETURN)
#define APP_PAD_EMUL_BUTTON_Y			(VK_HOME)

#define APP_PAD_EMUL_LEFT_TRIGGER		(VK_NEXT)
#define APP_PAD_EMUL_RIGHT_TRIGGER		(VK_PRIOR)

#define APP_PAD_EMUL_BUTTON_LEFT_THUMB		(VK_NUMPAD8)
#define APP_PAD_EMUL_BUTTON_RIGHT_THUMB		(VK_NUMPAD2)
